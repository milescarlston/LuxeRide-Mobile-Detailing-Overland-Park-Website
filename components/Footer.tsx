    ...
    <footer className="border-t border-white/10 bg-[#0A0A0A]">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          {/* Brand */}
          <div>
            <Link href="/" className="text-xl font-bold tracking-tight text-[#FAFAFA]">
              <span className="text-[#C9A84C]">Luxe</span>Ride
            </Link>
            <p className="mt-3 text-sm leading-relaxed text-[#FAFAFA]/60">
              {BUSINESS.tagline}. Professional mobile car detailing serving{" "}
              {BUSINESS.address.city}, {BUSINESS.address.state} and surrounding areas.
            </p>
            {/* Social icons */}
            <div className="mt-4 flex gap-3">
              <a
                ...
                aria-label="Facebook"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 text-[#FAFAFA]/60 transition-colors hover:border-[#C9A84C] hover:text-[#C9A84C]"
              >
              ...
              {SERVICES.map((service) => (
                <li key={service.slug}>
                  <Link
                    ...
                    className="text-sm text-[#FAFAFA]/60 transition-colors hover:text-[#C9A84C]"
                  >
                    {service.shortTitle}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link href="/about" className="text-sm text-[#FAFAFA]/60 transition-colors hover:text-[#C9A84C]">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/gallery" className="text-sm text-[#FAFAFA]/60 transition-colors hover:text-[#C9A84C]">
                  Gallery
                </Link>
              </li>
              <li>
                <Link href="/blog" className="text-sm text-[#FAFAFA]/60 transition-colors hover:text-[#C9A84C]">
                  Blog
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-sm text-[#FAFAFA]/60 transition-colors hover:text-[#C9A84C]">
                  Contact / Book Now
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <address className="mt-4 space-y-2 not-italic">
              <p className="text-sm text-[#FAFAFA]/60">
                <a href={BUSINESS.phoneHref} className="transition-colors hover:text-[#C9A84C]">
                  {BUSINESS.phone}
                </a>
              </p>
              <p className="text-sm text-[#FAFAFA]/60">
                <a href={`mailto:${BUSINESS.email}`} className="transition-colors hover:text-[#C9A84C]">
                  {BUSINESS.email}
                </a>
              </p>
              <p className="text-sm text-[#FAFAFA]/60">
              ...
              <p className="text-sm text-[#FAFAFA]/60">{BUSINESS.hours}</p>
            </address>
            <h3 className="mt-6 text-sm font-semibold uppercase tracking-wider text-[#C9A84C]">
              Service Area
            </h3>
