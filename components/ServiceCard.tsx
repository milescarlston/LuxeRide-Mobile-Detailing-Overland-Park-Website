...
export default function ServiceCard({ service }: { service: Service }) {
  return (
    <Link
      ...
      className="group flex flex-col rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:border-[#1E5FAE]/30 hover:shadow-md"
    >
      <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-[#1E5FAE]/10 text-[#1E5FAE]">
        {icons[service.icon] ?? icons.sparkles}
      </div>
      <h3 className="text-lg font-semibold text-[#1C1C1C]">{service.shortTitle}</h3>
